...
import { idlFactory } from './Celestial_frontend.did.js';
export { idlFactory } from './Celestial_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_CELESTIAL_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./Celestial_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the Celestial_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./Celestial_frontend.did.js")._SERVICE>}
 */
export const Celestial_frontend = createActor(canisterId);
