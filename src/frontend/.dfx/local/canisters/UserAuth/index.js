...
import { idlFactory } from './UserAuth.did.js';
export { idlFactory } from './UserAuth.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_USERAUTH;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./UserAuth.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the UserAuth canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./UserAuth.did.js")._SERVICE>}
 */
export const UserAuth = createActor(canisterId);
